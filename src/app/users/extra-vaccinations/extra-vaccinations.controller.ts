...
import { Controller, Put, Body, Delete, Post, Param, Get, ForbiddenException, Query } from '@nestjs/common';
...
export class ExtraVaccinationsController {
    ...
    async editExtraVaccination(
        ...
        const userId = await this.extraVaccinationsService.getUserId(vaccinationId);
